...
Rails.application.config.sorcery.submodules = [:user_activation, :remember_me, :reset_password, :session_timeout, :brute_force_protection, :activity_logging, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  # fix see http://martinottenwaelter.fr/2010/12/ruby19-and-the-ssl-error/
  if Rails.env != 'production' && File.exists?('/opt/local/share/curl/curl-ca-bundle.crt')
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.activation_token_expiration_period = 1800
    ...
    #
    user.activation_needed_email_method_name = :confirm_registration


    # activation success email method on your mailer class.
    # Default: `:activation_success_email`
    #
    user.activation_success_email_method_name = :activation
